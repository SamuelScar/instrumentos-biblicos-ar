...
Este repositório reúne software, textos, imagens, áudios, modelos 3D e componentes de terceiros.
Cada categoria é licenciada de forma independente, conforme descrito abaixo.

## Código-fonte do projeto

O código-fonte autoral deste projeto é disponibilizado sob a **PolyForm Noncommercial License
1.0.0**.

Required Notice: Copyright 2026 Samuel de Souza
...
The licensor is the individual or entity offering these terms, and the software is the software the
...
Os textos, dados educacionais, ilustrações e demais conteúdos autorais criados especificamente para
o projeto são licenciados sob a **Creative Commons Attribution-NonCommercial 4.0 International
(CC BY-NC 4.0)**.

Essa licença permite compartilhar e adaptar o conteúdo para fins não comerciais, desde que a autoria
seja atribuída e as alterações sejam indicadas. O texto legal completo está disponível em
<https://creativecommons.org/licenses/by-nc/4.0/legalcode>.

## Materiais de terceiros

Bibliotecas, modelos 3D, imagens, áudios, fontes e quaisquer outros materiais obtidos de terceiros
não são abrangidos pelas licenças acima. Eles permanecem sujeitos às licenças e aos direitos de seus
respectivos titulares.

As bibliotecas utilizadas diretamente pela aplicação estão relacionadas em
